...
(function (global) {
  ...
  const NAMES = {
    ...
    // "中文" alone stopped being an answer the moment there were two.
  ...
  S.en = {
    ...
    "work.pause": "Pause",
    "work.stop": "Stop",
    "work.stopped": "Stopped. {n} read, {left} not scanned",
    "work.resume": "Resume",
  ...
  S.it = {
    ...
    "work.pause": "Pausa",
    "work.stop": "Ferma",
    "work.stopped": "Fermata. {n} letti, {left} non scansionati",
  ...
  S.es = {
    ...
    "work.pause": "Pausa",
    "work.stop": "Detener",
    "work.stopped": "Detenida. {n} leídos, {left} sin escanear",
  ...
  S.fr = {
    ...
    "work.pause": "Pause",
    "work.stop": "Arrêter",
    "work.stopped": "Arrêtée. {n} lus, {left} non scannés",
  ...
  S.de = {
    ...
    "work.pause": "Pause",
    "work.stop": "Stoppen",
    "work.stopped": "Gestoppt. {n} gelesen, {left} nicht gescannt",
  ...
  S.pt = {
    ...
    "work.pause": "Pausa",
    "work.stop": "Parar",
    "work.stopped": "Parada. {n} lidos, {left} por analisar",
    "work.resume": "Retomar",
  ...
  S.zh = {
    ...
    "work.pause": "暂停",
    "work.stop": "停止",
    "work.stopped": "已停止。已读 {n} 个，{left} 个未扫描",
    "work.resume": "继续",
  ...
  // Traditional Chinese, in Taiwanese usage. Not a character conversion of the
  // block above: the words differ too. 軟體 not 软件, 檔案 not 文件, 資料夾 not
  // 文件夹, 設定 not 设置, 搜尋 not 搜索, 開啟 not 打开, 複製 not 复制. A page
  // that converts the characters and keeps the mainland vocabulary reads as a
  // translation of a translation, which is worse than English.
  S["zh-Hant"] = {
    "cam.settings": "設定",
    "cam.found": "已找到 {n} 個",
    "res.compact": "精簡",
    "act.exportAs": "以此格式匯出",
    "qrgen.as": "以此格式重新產生 QR Code",
    "res.more": "更多",
    "res.moreHelp": "其他格式，以及把 QR Code 還原成圖片",
    "cam.flip": "鏡像",
    "cam.flipHelp": "有些鏡頭交出的畫面本來就是鏡像的。本頁從不鏡像；如果你的鏡頭會，就開啟這個。",
    "cam.auto": "自動",
    "cam.autoHelp": "一看到 QR Code 就自己擷取畫面，然後仔細讀取",
    "cam.closer": "畫面裡有 QR Code，但太小讀不出來。請靠近一點。",
    "cam.aim": "把 QR Code 對準這裡",
    "cam.reading": "讀取中…",
    "cam.help": "對準時會自動讀取。定格畫面後，可以替難讀的 QR Code 框一個區域。",
    "cam.checking": "正在仔細讀取畫面裡的內容…",
    "cam.autoGot": "讀出 {found} 個中的 {n} 個",
    "cam.autoNone": "那裡沒有能讀出的內容。靠近一點、擺正，或者自己框一個區域。",
    "cam.device": "鏡頭",
    "cam.deviceHelp": "透過「接續互通相機」連接的 iPhone 會像一般鏡頭一樣出現在這裡",
    "cam.switch": "切換鏡頭",
    "act.details": "詳細資料",
    "stat.toRead": "待讀取",
    "res.filters": "篩選",
    "res.export": "匯出",
    "rename.toggle": "先重新命名檔案",
    "row.flag": "標記待查",
    "row.unflag": "取消標記",
    "filter.flagged": "已標記",
    "csv.loaded": "來自 {file} 的 {n} 個 QR Code，欄位「{col}」",
    "csv.clear": "移除",
    "csv.noHeader": "找不到標題列，已使用第一欄",
    "csv.skipped": "已略過 {n} 個空白列",
    "filter.kind": "類型",
    "filter.kindAll": "全部類型",
    "stat.uniqueHelp": "每個不同內容只算一列：同一個碼的兩張照片只算一次",
    "rename.example": "例如：{name}",
    "drop.keyboard": "也可以把檔案拖到這裡，或使用下面的按鈕",
    "work.progress": "正在掃描第 {done} / {total} 張圖片",
    "work.now": "目前：{name}",
    "work.pause": "暫停",
    "work.stop": "停止",
    "work.stopped": "已停止。已讀 {n} 個，{left} 個未掃描",
    "work.resume": "繼續",
    "work.paused": "已暫停。還有 {left} 張待掃描",
    "work.slow": "{name} 有點慢：圖片較大或較難讀取",
    "work.done": "已完成 {n} 張圖片",
    "link.title": "這個 QR Code 會帶你去哪裡",
    "link.goes": "此連結將開啟",
    "link.full": "完整網址",
    "link.open": "開啟",
    "link.cancel": "不要開啟",
    "link.warn.userinfo": "網址在 @ 之前藏了真正的站台。開啟的是 @ 之後的部分，而不是你先看到的那一段。",
    "link.warn.punycode": "站台名稱以編碼形式書寫，可能逐字模仿另一個名稱。",
    "link.warn.insecure": "未加密。在該站台輸入的任何內容都會以明文傳送。",
    "link.warn.ipHost": "是一串裸位址，而不是站台名稱。",
    "link.warn.manyLabels": "一長串名稱。真正的站台是結尾前的那一段。",
    "link.warn.veryLong": "網址非常長；它的開頭和結尾無法同時顯示。",
    "trust.badge": "100% 本機 · 不會上傳任何內容",
    "cam.zoneTitle": "把鏡頭對準 QR Code",
    "cam.zoneSub": "移動中即可掃描，不會錄下任何內容",
    "drop.orChoose": "或從這台電腦選擇",
    "cam.title": "即時掃描",
    "cam.freeze": "定格",
    "cam.resume": "繼續",
    "cam.frozen": "已定格。在 QR Code 周圍拖一個框來讀取。",
    "qrgen.label": "重新產生 QR Code",
    "qrgen.download": "下載（{n}）",
    "qrgen.none": "還沒有可以重新產生的 QR Code。",
    "qrgen.working": "正在繪製 QR Code…",
    "drop.folderMore": "再新增一個資料夾",
    "insp.keys": "拖出一個框，或拖動它的控制點。捲動可平移，雙指或 Ctrl+捲動可縮放，按住空白鍵拖曳可平移。方向鍵微調，Shift+方向鍵改變大小，Enter 讀取，Esc 關閉。",
    "res.summary": "讀出 {codes} 個 QR Code，其中 {uniq} 個不同。",
    "insp.zoomIn": "放大",
    "insp.zoomOut": "縮小",
    "insp.fit": "符合整張圖片",
    "insp.fitShort": "符合",
    "insp.open": "指出 QR Code 的位置",
    "insp.title": "指出 QR Code 的位置",
    "insp.hint": "在 QR Code 周圍拖一個框，然後讀取該區域。不會上傳任何內容，裁切出的部分就在這個分頁裡讀取。",
    "insp.rescan": "讀取這個區域",
    "insp.close": "關閉",
    "insp.working": "正在讀取該區域…",
    "insp.found": "在該區域讀出的 QR Code：{n}",
    "insp.none": "該區域仍然沒有可讀的內容。下一步可以試試更近或更正的照片。",
    "insp.prefilled": "這個框是掃描器看到 QR Code 的位置。如果不準，可以調整。",
    "app.tagline": "QR Code 掃描器",
    "nav.source": "原始碼",

    "hero.title": "一次掃描整個資料夾裡的每一個 QR Code，也可以即時掃描",
    "hero.sub": "別的掃描器一次只看一張圖。把整個資料夾、單張照片或一個壓縮檔拖到這裡，你會得到每張圖片裡的每一個 QR Code，以及它來自哪個檔案。",
    "hero.trust": "不會上傳任何內容。一切都在你的電腦上執行。",

    "tab.images": "圖片",
    "tab.camera": "鏡頭",

    "drop.title": "拖放，或瀏覽",
    "drop.sub": "一張照片、一個資料夾、多個資料夾，或一個壓縮檔",
    "drop.browse": "瀏覽檔案",
    "drop.folder": "選擇資料夾",
    "drop.paste": "貼上圖片",
    "drop.shoot": "拍照",

    "cam.off": "鏡頭已關閉。<br>對準 QR Code 即可即時讀取。",
    "cam.start": "開啟鏡頭",
    "cam.stop": "關閉鏡頭",
    "cam.looking": "正在尋找 QR Code…",
    "cam.denied": "鏡頭權限遭到拒絕。",
    "cam.none": "這裡沒有可用的鏡頭。",
    "cam.read": "已讀出的 QR Code：{n}",

    "res.title": "結果",
    "res.private": "100% 私密 · 在你的瀏覽器中執行",
    "res.empty": "你掃描的 QR Code 會顯示在這裡。",
    "res.nothing": "裡面沒有可讀的內容。這裡需要的是圖片。",
    "res.search": "在 QR Code 內容中搜尋…",
    "res.noMatch": "沒有符合該搜尋的結果。",
    "res.noCode": "找不到 QR Code",
    "res.detected": "找到 QR Code，但讀不出來",
    "engine.loading": "正在啟動讀取器",
    "engine.ready": "讀取器就緒",
    ...
    "act.clear": "清空",
    "act.cancel": "取消",
    "act.clearAsk": "丟棄目前讀出的所有結果？",
    "act.open": "開啟",
    "act.saveContact": "儲存聯絡人",
    "act.reveal": "顯示",
    "act.hide": "隱藏",

    "rename.pattern": "新名稱",
    "rename.code": "QR Code 內容",
    "rename.short": "QR Code 中有用的部分",
    "rename.nameCode": "原名 + QR Code",
    "rename.keep": "保留原來的名稱",
    "rename.zip": "下載 ZIP（{n}）",
    "rename.none": "這裡沒有圖片可以用 QR Code 來命名。",
    "rename.preview": "將儲存為",

    "dupe.badge": "出現在 {n} 張圖片中",

    "err.advice": "請靠近一點再試，把 QR Code 擺平、光線均勻。或者緊貼它裁切。",
    "err.unopenable": "無法讀取：格式不支援，或檔案已損毀",
    "err.fileAdvice": "轉成 PNG 或 JPEG 通常可行。本機應用程式能讀取這個瀏覽器讀不了的格式。",

    "adv.localTitle": "本機應用程式正在執行",
    "adv.localOn": "本機的程式副本正在回應，因此本頁也可以直接處理檔案所在位置的檔案。",
    "adv.scan": "掃描磁碟上的檔案",
    "adv.paths": "資料夾或檔案，每行一個",
    "adv.recreate": "重新產生 QR Code 圖片",
    "adv.organize": "整理為 with_qr / without_qr",
    "adv.delete": "刪除沒有 QR Code 的圖片",
    "adv.confirmOrganize": "把每張已掃描的圖片移動到旁邊的 with_qr / without_qr 資料夾？",
    "adv.confirmDelete": "將永久刪除每張沒有 QR Code 的已掃描圖片。此操作無法復原。是否繼續？",
    "adv.scanFirst": "請先掃描磁碟上的檔案。",

    "foot.privacy": "你的圖片絕不會離開這台裝置。",

    "kind.url": "連結", "kind.wifi": "Wi-Fi 網路", "kind.contact": "聯絡人",
    "kind.payment": "付款", "kind.email": "電子郵件", "kind.phone": "電話號碼",
    "kind.sms": "簡訊", "kind.location": "位置", "kind.event": "行程",
    "kind.crypto": "加密貨幣位址", "kind.otp": "兩步驟驗證設定",
    "kind.reference": "參考編號", "kind.text": "文字",

    "f.site": "站台", "f.reference": "編號", "f.address": "位址",
    "f.network": "網路", "f.security": "加密方式", "f.password": "密碼",
    "f.name": "姓名", "f.phone": "電話", "f.email": "電子郵件", "f.company": "公司",
    "f.payee": "收款人", "f.iban": "IBAN", "f.amount": "金額",
    "f.subject": "主旨", "f.message": "內容", "f.number": "號碼",
    "f.latitude": "緯度", "f.longitude": "經度",
    "f.title": "標題", "f.starts": "開始", "f.ends": "結束", "f.where": "地點",
    "f.account": "帳戶", "f.issuer": "服務", "f.algorithm": "演算法",
    "f.secret": "密鑰", "f.content": "內容",
  };
